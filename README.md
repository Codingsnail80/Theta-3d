...
How to use:
To use this render, you will need to install pygame (It is the backend used to make the renderer, so it's essential to install this before use otherwie it will not work)

# Commands For Installing Pygame

These instructions assume you already know how to interact with the terminal and Python on  your system. If you don't, then I would recommend researching this before continuing.
...
You may need to use "sudo" at the beginning of your command if you are having trouble with permissions.
...
## main.py
This demo allows for movement with WASD and camera movement with the arrow keys.

## mouseTest.py
This demo doesn't properly handle rendering order, but it does showcase how to use a mouse for camera movement.
